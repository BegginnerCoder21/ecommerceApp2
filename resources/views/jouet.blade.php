...
<head>
    ...
    <link href="jouet.css" rel="stylesheet">
...
<body>
    ...
    <div class="galerie1">
        <div class="galerie11">
            <img src="IMAGES/61UgUyZV1PL._AC_SX425_.jpg" width="100%" height="100%">
            <h6>LOT 60</h6>
        </div>
        <div class="galerie12">
            <img src="IMAGES/_c_u_cuisine-blanche-avec-plaques-de-cuisson-interactives-hape-02.jpg" width="100%" height="100%">
            <h6>LOT 61</h6>
        </div>
        <div class="galerie13">
            <img src="IMAGES/20222.jpg" width="100%" height="100%">
            <h6>LOT 62</h6>
        </div>
        <div class="galerie14">
            <img src="IMAGES/coffret-monde-medieval-papo.jpg" width="100%" height="100%">
            <h6>LOT 63</h6>
        </div>
    </div>
    ...
    <div class="galerie2">
        <div class="galerie21">
            <img src="IMAGES/la_cuisine_de_jouets_hape_s_amuse_et_apprend_en_jouant_3033-1.jpg" width="100%" height="100%">
            <h6>LOT 64</h6>
        </div>
        <div class="galerie22">
            <img src="IMAGES/lot.jpg" width="100%" height="100%">
            <h6>LOT 65</h6>
        </div>
        <div class="galerie23">
            <img src="IMAGES/téléchargement (12).jpg" width="100%" height="100%">
            <h6>LOT 66</h6>
        </div>
        <div class="galerie24">
            <img src="IMAGES/6000203774888.jpg" width="100%" height="100%">
            <h6>LOT 67</h6>
        </div>
    </div>
