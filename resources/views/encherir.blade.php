...
<div class="image">
            <img src="IMAGES/téléchargement (5).jpg" width="30%" height="50%">
        </div>
        <div class="description">
            <h4>LOT 11</h4>
            <p>
                Une montre de qualité ,de luxe ,originale, pour des gens spéciaux que
                vous etes
            </p>
            <h4>PRIX : 50000fr</h4>
</div>
            ...
            <div class="relative flex items-center space-x-4">
                ...
                <div class="flex flex-col leading-tight">
                    <div class="text-2xl mt-1 flex items-center">
                        <span class="text-gray-700 mr-3">Echerisez</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="chat-message">
                <div class="flex items-end">
                    <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
                        <div><span class="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-gray-300 text-gray-600">1000000 fcfa</span></div>
                    </div>
